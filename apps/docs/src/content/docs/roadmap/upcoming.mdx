...
<Aside type="note" title="Beta Roadmap">
  The Booking Kit is in **beta**. Planned features, timelines, and priorities may change based on community feedback and real-world usage.
</Aside>
