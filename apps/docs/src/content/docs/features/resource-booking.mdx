...
See the [Database Schema](/database/schema) guide for setup instructions.

## Related

- [Team Scheduling](/features/team-scheduling) — Assign bookings to team members
- [Seat & Group Bookings](/features/seats) — Manage capacity within one time slot
- [Availability Rules](/features/availability) — RRULE and override patterns
