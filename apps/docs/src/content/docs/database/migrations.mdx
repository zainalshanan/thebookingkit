...
The constraint excludes `cancelled`, `rejected`, and `rescheduled` statuses, allowing old bookings that have been moved to be replaced by new ones without double-booking violations.
