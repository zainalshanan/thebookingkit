...
### Resource & Capacity-Based Booking

The Booking Kit now supports **resource-based booking** — book restaurant tables, yoga mats, meeting rooms, tennis courts, coworking desks, and any physical bookable unit with capacity-aware scheduling.
