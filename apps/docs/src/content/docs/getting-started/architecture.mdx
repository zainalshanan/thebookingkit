---
title: Architecture
description: How SlotKit's three layers work together.
---

SlotKit is organized into three layers that can be used independently or together.
...
SlotKit prevents double-bookings at two levels:
