...
```typescript
import type { AvailabilityRuleInput } from "@slotkit/core";
...
```typescript
import { isSlotAvailable } from "@slotkit/core";
...
```typescript
import type { AvailabilityOverrideInput, BookingInput } from "@slotkit/core";
