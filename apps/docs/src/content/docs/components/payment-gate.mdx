...
The component source is fetched from the docs registry at install time. Run `npx thebookingkit add payment-gate` to copy it into your project, or browse the latest source on [GitHub](https://github.com/zainalshanan/thebookingkit/blob/main/registry/ui/src/components/payment-gate.tsx).
