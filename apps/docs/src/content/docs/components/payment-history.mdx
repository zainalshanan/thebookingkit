...
Run `npx thebookingkit add payment-history` to copy the source into your project, or browse the latest source on [GitHub](https://github.com/zainalshanan/thebookingkit/blob/main/registry/ui/src/components/payment-history.tsx).
