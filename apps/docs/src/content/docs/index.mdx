...
hero:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: View on GitHub
      link: https://github.com/your-org/slotkit
      icon: external
---
...
<CardGrid>
  <Card title="@slotkit/core" icon="seti:typescript">
  ...
  <Card title="@slotkit/db" icon="seti:db">
  ...
  <Card title="@slotkit/ui" icon="seti:react">
